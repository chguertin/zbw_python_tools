...
import os
import chrlxPipe.chrlxFuncs as cFuncs
reload(cFuncs)
from functools import partial
import chrlxPipe.projectSetter as projectSetter
import sys
...
def populateAssets(current, *args):
	...
	charList, propList, setList = cFuncs.getProjectAssetList(current) #this should returen (chars, props, sets)
